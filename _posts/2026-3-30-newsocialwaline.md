...
Waline是基于Valine衍生的带后端评论系统。可以将 Waline 等价成 With backend Valine。新版本Waline比Valine功能更多，还对Pjax更友好，但是数据迁移过程中，还是有好多坑，Valine创建的数据库内容和Waline有一点点不一样，导入的时候转换这些就花了好久时间。花了两天终于把数据迁移过来了，感觉有后端还是方便些。再花半天搞了Waline和Instantclick的适配，终于实现无刷新了，感觉速度飞起来
