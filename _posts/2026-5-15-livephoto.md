...
:point_right: [仓库地址](https://github.com/link9596/WebLivePhoto) :point_right: [演示页](https://atlinker.cn/demo/livephoto.html)
...
想要破解只能使用 fetch 或 XMLHttpRequest 获取视频数据，转为 Blob 对象，再创建 Blob URL 赋给video标签。浏览器嗅探器就无法识别这类动态生成的 Blob URL，就不会被劫持了。但这样就不能跨域了，大家自己权衡吧= =，反正我觉得这类浏览器兼不兼容无所谓了![](/exp/razz.gif)...
