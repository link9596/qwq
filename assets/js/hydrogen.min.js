(function() {
  ...
  let funnyCard = null, textSpan = null, bubble = null;
  ...
  function triggerComboAnimation() {
    ...
    if (bubble.animate) {
      ...
      const animation = bubble.animate(keyframes, { duration: 200, easing: 'cubic-bezier(0.2, 0.9, 0.4, 1.1)', fill: 'forwards' });
  ...
  function init() {
    ...
    if (!funnyCard || !textSpan || !bubble) {
      console.warn('滑稽计数器 DOM 未找到，稍后重试');
      setTimeout(init, 300);
      return;
    }
